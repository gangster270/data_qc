...
DEFAULT_CONFIG = {
    ...
    "sensors": {
        "temp": {"label": "온도", "unit": "℃", "min": -20, "max": 60, "flat_n": 36, "spike": 5.0},
        "rh": {"label": "습도", "unit": "%", "min": 0, "max": 100, "flat_n": 36, "spike": 30.0},
        "soil_temp": {"label": "배지온도", "unit": "℃", "min": -10, "max": 60, "flat_n": 72, "spike": 4.0},
        "vwc": {"label": "배지습도", "unit": "m³/m³", "min": 0.0, "max": 0.75, "flat_n": 72, "spike": 0.15},
    ...
    "qc": {
        ...
        "flatline_ignore_zero": ["ppfd", "solar"],
        "spike_enabled": True,
        "spike_warn_count": 3,
        ...
        "pair_divergence": {"temp": 1.0, "soil_temp": 1.0, "rh": 5.0, "vwc": 0.05, "ppfd": 0.15},
        "transmittance": {
            "enabled": True,
    ...
    "verification": {
        ...
        "tolerance": {
            "temp": 0.5, "rh": 3.0, "soil_temp": 0.5, "vwc": 0.03,
